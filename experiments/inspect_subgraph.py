...
def inspectSubGraph(g,bunch, expand=True, verbose=False, label=True,pos = "kk"):
    ...
    if pos == "kk":
        nx.draw_kamada_kawai(sg, node_color =sgc, node_shape = '.',alpha=.5, labels=labels, font_size=8, figsize=(20,10))
    elif pos =="spring":
        nx.draw_spring(sg, node_color =sgc, node_shape = '.',alpha=.5, labels=labels, font_size=8, figsize=(20,10))
    elif pos == "spectral":
        nx.draw_spectral(sg, node_color =sgc, node_shape = '.',alpha=.5, labels=labels, font_size=8, figsize=(20,10))
    else:
        nx.draw_circular(sg, node_color =sgc, node_shape = '.',alpha=.5, labels=labels, font_size=8, figsize=(20,10))
